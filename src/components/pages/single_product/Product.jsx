...
import ProductsWithScrool from "../home/ProductsWithScrool";
...
function Product() {
  ...
  const productDatas = products.filter(function (value, index, array) {
        ...
        <div className="product_datas">
          <div className="product_datas__main">
            <div>
              ...
              <span className="product_datas__old_price">
                ${product?.price}
              </span>
